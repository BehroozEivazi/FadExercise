...
imageChannels = 3
batchSize = 4
numberOfTrainImages = 2000
numberOfValidationImages = 1000
...
train_generator = train_datagen.flow_from_directory(
    r"G:\DataSet\Cats_Dogs\data\train",
    target_size=(imageSize, imageSize),
    class_mode='categorical',
    batch_size=batchSize, )

validation_generator = validation_datagen.flow_from_directory(
    r"G:\DataSet\Cats_Dogs\data\validation",  # train
    target_size=(imageSize, imageSize),
    class_mode='categorical',
    batch_size=batchSize)
...
filepath = "./myClassifier/mobileNetV2/"
filepath = r"G:/chekPoints/" + "saved-model_mbNetV2-{epoch:02d}.hdf5"
